    ...
    <Card>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-white flex items-center gap-2">
          <FaHistory className="text-invoforge-accent" />
          Transaction History
        </h2>
        <button
        ...
        <div className="space-y-3">
          {transactions.map((tx) => {
            ...
            return (
              <div
                key={tx.id}
                className="bg-invoforge-background hover:bg-invoforge-surface rounded-xl p-4 transition-all border border-invoforge-primary/20 hover:border-invoforge-accent/30"
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <a
                    ...
                    className="text-invoforge-accent hover:text-invoforge-accent text-sm flex items-center gap-1 transition-colors"
                  >
                ...
                <div className="flex justify-between items-center mt-3 pt-3 border-t border-invoforge-primary/20">
